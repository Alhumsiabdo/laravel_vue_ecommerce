...
<template>
  <section class="bg-gray-50 dark:bg-gray-900 p-3 sm:p-5">
    <!-- dialog for adding product or editing prodcut -->
      ...
      <form class="max-w-md mx-auto" @submit.prevent="AddProduct()">
        ...
        <div class="relative z-0 w-full mb-5 group">
          ...
          <label for="floating_qty"
            class="peer-focus:font-medium absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:translate-x-1/4 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Qauntity</label>
        </div>
